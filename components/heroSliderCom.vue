            ...
            <div class="slider">
                ...
                <div class="slide" v-show="currentSlide == index" v-for="(slide, index) in slides" >
                    ...
                    <div class="slideContent">
                        ...
                        <div class="links">
                            <a class="projectLink" target="_blank" @mouseenter="isPause = true" @mouseleave="isPause = false" v-if="slide.githubLink != ''" :href="slide.githubLink"><font-awesome-icon icon="fa-brands fa-github" /></a>
                            <a class="projectLink" target="_blank" @mouseenter="isPause = true"  @mouseleave="isPause = false" v-if="slide.webLink != ''" :href="slide.webLink"><font-awesome-icon icon="fa-solid fa-globe" /></a>
